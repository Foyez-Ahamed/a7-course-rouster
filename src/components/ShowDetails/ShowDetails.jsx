const ShowDetails = ({courses, totalCreditHour, hourRemaining, coursePrice}) => {
    return (
        ...
        <div className="card-body">
         <h1 className="text-[#2F80ED] text-[17px] font-bold py-1">Credit Hour Remaining {hourRemaining} hr</h1>
         <hr />   
        ...
        <p className="text-[#423e3e] text-[18px] mt-4 p-1">Total Credit Hour : {totalCreditHour} </p>
